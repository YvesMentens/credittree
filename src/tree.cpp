...
bool Tree::calculateTotalCosts(int method, double p0, double p1, double ROI,double lambda, int sumWeights){
  ...
  this->performance = -EmpCreditScoringCpp(scores, classes, p0, p1, ROI) + lambda*(this->nNodes+1.0);
